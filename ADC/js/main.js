...
d3.csv('data/Data.csv', function(data) {
  ...
  var keysNum = ["YEAR","AREA [mm^2]", "fin_hf [Hz]", "SNDR_hf [dB]", "SNR [dB]", "DR [dB]", "-THD [dB]", "SFDR [dB]", "SNDR_plot [dB]", "P [W]", "fs [Hz]", "OSR", "fsnyq [Hz]", "P/fsnyq [pJ]", "FOMW_hf [fJ/conv-step]", "FOMS_lf [dB]", "FOMS_hf [dB]", "FOMW_hf/fsnyq", "FOMS,hf+10log(fsnyq)"];
  var keysStr = [""];
  var keysMeta = ["TITLE","ABSTRACT"];
  ...
  var colors = ["#FF0000"]; //supports up to 15 different groups

  var groups = createGroups(data,group);
  var groupColors={};
  var k=0;
  groups.forEach(function(d) {
    groupColors[d]="#FF0000";
    k++;
